...
#ifndef _CAM_CSIPHY_1_3_0_HWREG_H_
#define _CAM_CSIPHY_1_3_0_HWREG_H_

#include "../cam_csiphy_dev.h"

struct cam_cphy_dphy_status_reg_params_t status_regs_1_3_0 = {
	.csiphy_3ph_status0_offset = 0x01E0,
	.csiphy_2ph_status0_offset = 0x0090,
	.cphy_lane_status = {0x01F8, 0x03F8, 0x05F8},
	.csiphy_3ph_status_size = 8,
	.csiphy_2ph_status_size = 16,
};

struct csiphy_reg_t csiphy_lane_en_reg_1_3_0[] = {
	{0x0814, 0x00, 0x00, CSIPHY_LANE_ENABLE},
};

struct csiphy_reg_t csiphy_common_reg_1_3_0[] = {
...
struct csiphy_reg_t csiphy_reset_enter_reg_1_3_0[] = {
	{0x0800, 0x01, 0x01, CSIPHY_DEFAULT_PARAMS},
};

struct csiphy_reg_t csiphy_reset_exit_reg_1_3_0[] = {
	{0x0800, 0x02, 0x00, CSIPHY_2PH_REGS},
	{0x0800, 0x00, 0x00, CSIPHY_2PH_COMBO_REGS},
	{0x0800, 0x0E, 0xBE8, CSIPHY_3PH_REGS},
};

struct csiphy_reg_t csiphy_irq_reg_1_3_0[] = {
...
struct csiphy_reg_t csiphy_2ph_v1_3_0_reg[] = {
...
struct csiphy_reg_t csiphy_2ph_v1_3_0_combo_mode_reg[] = {
	{0x0030, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0024, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0028, 0x00, 0x00, CSIPHY_DNP_PARAMS},
	{0x0000, 0x91, 0x00, CSIPHY_DEFAULT_PARAMS},
...
struct csiphy_reg_t csiphy_3ph_v1_3_0_reg[] = {
...
struct csiphy_reg_t datarate_130_80Msps[] = {
...
struct csiphy_reg_t datarate_130_300Msps[] = {
	{0x144, 0xA2, 0x00,	CSIPHY_DEFAULT_PARAMS},
	{0x988, 0x05, 0x00,	CSIPHY_DEFAULT_PARAMS},
	{0x980, 0x61, 0x00,	CSIPHY_DEFAULT_PARAMS},
	{0x9B4, 0x04, 0x0A,	CSIPHY_DEFAULT_PARAMS},
...
static struct data_rate_reg_info_t data_rate_settings_1_3_0[] = {
	{
		/* ((80 MSpS) * (10^6) * (2.28 bits/symbol)) rounded value */
		.bandwidth = 4332000000,
		.data_rate_reg_array_size = ARRAY_SIZE(datarate_130_80Msps),
		.data_rate_reg_array[0][0] = datarate_130_80Msps,
		.data_rate_reg_array[1][0] = datarate_130_80Msps,
		.data_rate_reg_array[2][0] = datarate_130_80Msps,
		.data_rate_reg_array[3][0] = datarate_130_80Msps,
		.data_rate_reg_array[4][0] = datarate_130_80Msps,
		.data_rate_reg_array[5][0] = datarate_130_80Msps,
		.data_rate_reg_array[6][0] = datarate_130_80Msps,
		.data_rate_reg_array[7][0] = datarate_130_80Msps,
	},
	{
		/* ((100 MSpS) * (10^6) * (2.28 bits/symbol)) rounded value */
		.bandwidth = 6840000000,
		.data_rate_reg_array_size = ARRAY_SIZE(datarate_130_100Msps),
		.data_rate_reg_array[0][0] = datarate_130_100Msps,
		.data_rate_reg_array[1][0] = datarate_130_100Msps,
		.data_rate_reg_array[2][0] = datarate_130_100Msps,
		.data_rate_reg_array[3][0] = datarate_130_100Msps,
		.data_rate_reg_array[4][0] = datarate_130_100Msps,
		.data_rate_reg_array[5][0] = datarate_130_100Msps,
		.data_rate_reg_array[6][0] = datarate_130_100Msps,
		.data_rate_reg_array[7][0] = datarate_130_100Msps,
	},
	{
		/* ((200 MSpS) * (10^6) * (2.28 bits/symbol)) rounded value */
		.bandwidth = 7980000000,
		.data_rate_reg_array_size = ARRAY_SIZE(datarate_130_200Msps),
		.data_rate_reg_array[0][0] = datarate_130_200Msps,
		.data_rate_reg_array[1][0] = datarate_130_200Msps,
		.data_rate_reg_array[2][0] = datarate_130_200Msps,
		.data_rate_reg_array[3][0] = datarate_130_200Msps,
		.data_rate_reg_array[4][0] = datarate_130_200Msps,
		.data_rate_reg_array[5][0] = datarate_130_200Msps,
		.data_rate_reg_array[6][0] = datarate_130_200Msps,
		.data_rate_reg_array[7][0] = datarate_130_200Msps,
	},
	{
		/* ((300 MSpS) * (10^6) * (2.28 bits/symbol)) rounded value */
		.bandwidth = 10260000000,
		.data_rate_reg_array_size = ARRAY_SIZE(datarate_130_300Msps),
		.data_rate_reg_array[0][0] = datarate_130_300Msps,
		.data_rate_reg_array[1][0] = datarate_130_300Msps,
		.data_rate_reg_array[2][0] = datarate_130_300Msps,
		.data_rate_reg_array[3][0] = datarate_130_300Msps,
		.data_rate_reg_array[4][0] = datarate_130_300Msps,
		.data_rate_reg_array[5][0] = datarate_130_300Msps,
		.data_rate_reg_array[6][0] = datarate_130_300Msps,
		.data_rate_reg_array[7][0] = datarate_130_300Msps,
	}
};

struct data_rate_settings_t data_rate_delta_table_1_3_0 = {
	.num_data_rate_settings = ARRAY_SIZE(data_rate_settings_1_3_0),
	.data_rate_settings = data_rate_settings_1_3_0,
};

struct csiphy_reg_parms_t csiphy_v1_3_0 = {
	...
	.status_reg_params = &status_regs_1_3_0,
	.csiphy_common_reg_array_size = ARRAY_SIZE(csiphy_common_reg_1_3_0),
	.csiphy_reset_enter_array_size = ARRAY_SIZE(csiphy_reset_enter_reg_1_3_0),
	.csiphy_reset_exit_array_size = ARRAY_SIZE(csiphy_reset_exit_reg_1_3_0),
	.csiphy_2ph_config_array_size = ARRAY_SIZE(csiphy_2ph_v1_3_0_reg),
	.csiphy_3ph_config_array_size = ARRAY_SIZE(csiphy_3ph_v1_3_0_reg),
	.csiphy_2ph_combo_config_array_size = ARRAY_SIZE(csiphy_2ph_v1_3_0_combo_mode_reg),
	.csiphy_3ph_combo_config_array_size = 0,
	.csiphy_2ph_3ph_config_array_size = 0,
	.csiphy_interrupt_status_size = ARRAY_SIZE(csiphy_irq_reg_1_3_0),
	.csiphy_num_common_status_regs = 20,
	.aon_sel_params = NULL,
};

struct csiphy_ctrl_t ctrl_reg_1_3_0 = {
	.csiphy_common_reg = csiphy_common_reg_1_3_0,
	.csiphy_2ph_reg = csiphy_2ph_v1_3_0_reg,
	.csiphy_3ph_reg = csiphy_3ph_v1_3_0_reg,
	.csiphy_2ph_combo_mode_reg = csiphy_2ph_v1_3_0_combo_mode_reg,
	.csiphy_3ph_combo_reg = NULL,
	.csiphy_2ph_3ph_mode_reg = NULL,
	.csiphy_reg = &csiphy_v1_3_0,
	.csiphy_irq_reg = csiphy_irq_reg_1_3_0,
	.csiphy_reset_enter_regs = csiphy_reset_enter_reg_1_3_0,
	.csiphy_reset_exit_regs = csiphy_reset_exit_reg_1_3_0,
	.csiphy_lane_config_reg = csiphy_lane_en_reg_1_3_0,
	.data_rates_settings_table = &data_rate_delta_table_1_3_0,
	.csiphy_bist_reg = NULL,
	.getclockvoting = get_clk_voting_dynamic,
};

#endif /* _CAM_CSIPHY_1_3_0_HWREG_H_ */
