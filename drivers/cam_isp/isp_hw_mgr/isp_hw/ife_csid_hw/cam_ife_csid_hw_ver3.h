...
#ifndef _CAM_IFE_CSID_HW_VER3_H_
#define _CAM_IFE_CSID_HW_VER3_H_
...
#define IFE_CSID_VER3_RX_DL0_EOT_CAPTURED             BIT(0)
#define IFE_CSID_VER3_RX_DL1_EOT_CAPTURED             BIT(1)
#define IFE_CSID_VER3_RX_DL2_EOT_CAPTURED             BIT(2)
#define IFE_CSID_VER3_RX_DL3_EOT_CAPTURED             BIT(3)
#define IFE_CSID_VER3_RX_DL0_SOT_CAPTURED             BIT(4)
#define IFE_CSID_VER3_RX_DL1_SOT_CAPTURED             BIT(5)
#define IFE_CSID_VER3_RX_DL2_SOT_CAPTURED             BIT(6)
#define IFE_CSID_VER3_RX_DL3_SOT_CAPTURED             BIT(7)
#define IFE_CSID_VER3_RX_LONG_PKT_CAPTURED            BIT(8)
#define IFE_CSID_VER3_RX_SHORT_PKT_CAPTURED           BIT(9)
#define IFE_CSID_VER3_RX_CPHY_PKT_HDR_CAPTURED        BIT(10)
#define IFE_CSID_VER3_RX_CPHY_EOT_RECEPTION           BIT(11)
#define IFE_CSID_VER3_RX_CPHY_SOT_RECEPTION           BIT(12)
#define IFE_CSID_VER3_RX_ERROR_CPHY_PH_CRC            BIT(13)
#define IFE_CSID_VER3_RX_WARNING_ECC                  BIT(14)
#define IFE_CSID_VER3_RX_LANE0_FIFO_OVERFLOW          BIT(15)
#define IFE_CSID_VER3_RX_LANE1_FIFO_OVERFLOW          BIT(16)
#define IFE_CSID_VER3_RX_LANE2_FIFO_OVERFLOW          BIT(17)
#define IFE_CSID_VER3_RX_LANE3_FIFO_OVERFLOW          BIT(18)
#define IFE_CSID_VER3_RX_ERROR_CRC                    BIT(19)
#define IFE_CSID_VER3_RX_ERROR_ECC                    BIT(20)
#define IFE_CSID_VER3_RX_MMAPPED_VC_DT                BIT(21)
#define IFE_CSID_VER3_RX_UNMAPPED_VC_DT               BIT(22)
#define IFE_CSID_VER3_RX_STREAM_UNDERFLOW             BIT(23)
...
#define IFE_CSID_VER3_PATH_CAMIF_EOF                             BIT(3)
#define IFE_CSID_VER3_PATH_CAMIF_SOF                             BIT(4)
#define IFE_CSID_VER3_PATH_INFO_FRAME_DROP_EOF                   BIT(5)
#define IFE_CSID_VER3_PATH_INFO_FRAME_DROP_EOL                   BIT(6)
#define IFE_CSID_VER3_PATH_INFO_FRAME_DROP_SOL                   BIT(7)
#define IFE_CSID_VER3_PATH_INFO_FRAME_DROP_SOF                   BIT(8)
#define IFE_CSID_VER3_PATH_INFO_INPUT_EOF                        BIT(9)
#define IFE_CSID_VER3_PATH_INFO_INPUT_EOL                        BIT(10)
#define IFE_CSID_VER3_PATH_INFO_INPUT_SOL                        BIT(11)
#define IFE_CSID_VER3_PATH_INFO_INPUT_SOF                        BIT(12)
#define IFE_CSID_VER3_PATH_ERROR_PIX_COUNT                       BIT(13)
#define IFE_CSID_VER3_PATH_ERROR_LINE_COUNT                      BIT(14)
#define IFE_CSID_VER3_PATH_VCDT_GRP1_SEL                         BIT(15)
#define IFE_CSID_VER3_PATH_VCDT_GRP0_SEL                         BIT(16)
#define IFE_CSID_VER3_PATH_VCDT_GRP_CHANGE                       BIT(17)
#define IFE_CSID_VER3_PATH_FRAME_DROP                            BIT(18)
#define IFE_CSID_VER3_PATH_RECOVERY_OVERFLOW                     BIT(19)
#define IFE_CSID_VER3_PATH_ERROR_REC_CCIF_VIOLATION              BIT(20)
#define IFE_CSID_VER3_PATH_CAMIF_EPOCH0                          BIT(21)
#define IFE_CSID_VER3_PATH_CAMIF_EPOCH1                          BIT(22)
#define IFE_CSID_VER3_PATH_RUP_DONE                              BIT(23)
#define IFE_CSID_VER3_PATH_ILLEGAL_BATCH_ID                      BIT(24)
#define IFE_CSID_VER3_PATH_BATCH_END_MISSING_VIOLATION           BIT(25)
#define IFE_CSID_VER3_PATH_HEIGHT_OVERFLOW_VIOLATION             BIT(26)
#define IFE_CSID_VER3_PATH_WIDTH_OVERFLOW_VIOLATION              BIT(27)
#define IFE_CSID_VER3_PATH_HEIGHT_UNDERFLOW_VIOLATION            BIT(28)
#define IFE_CSID_VER3_PATH_WIDTH_UNDERFLOW_VIOLATION             BIT(29)
#define IFE_CSID_VER3_PATH_SENSOR_SWITCH_OUT_OF_SYNC_FRAME_DROP  BIT(30)
#define IFE_CSID_VER3_PATH_CCIF_VIOLATION                        BIT(31)

#define IFE_CSID_VER3_TOP_IRQ_STATUS_BUF_DONE                    BIT(14)

enum cam_ife_csid_ver3_input_core_sel {
    ...
    CAM_IFE_CSID_INPUT_CORE_SELECT_MAX,
};

enum cam_ife_csid_ver3_csid_reset_loc {
    CAM_IFE_CSID_RESET_LOCATION_PATH_ONLY,
    CAM_IFE_CSID_RESET_LOCATION_COMPLETE,
    CAM_IFE_CSID_RESET_LOCATION_MAX,
};

enum cam_ife_csid_ver3_csid_reset_cmd {
    CAM_IFE_CSID_RESET_COMMAND_IRQ_CTRL,
    CAM_IFE_CSID_RESET_COMMAND_SW_RST,
    CAM_IFE_CSID_RESET_COMMAND_HW_RST,
    CAM_IFE_CSID_RESET_COMMAND_HW_MAX,
};

struct cam_ife_csid_ver3_top_cfg {
...
struct cam_ife_csid_ver3_evt_payload {
    struct list_head            list;
    uint32_t                    irq_reg_val[CAM_IFE_CSID_IRQ_REG_MAX];
};

enum cam_ife_csid_ver3_stored_irq_masks {
	CAM_IFE_CSID_TOP_MSK,
	CAM_IFE_CSID_SOF_DISCARD_MSK,
	CAM_IFE_CSID_ERR_MSK,
	CAM_IFE_CSID_MAX_STORED_MSKS,
};

/*
 * struct cam_ife_csid_ver3_path_cfg: place holder for path parameters
 *
 ...
 *
 */
struct cam_ife_csid_ver3_path_cfg {
    ...
    uint32_t                             epoch_cfg;
    uint32_t   stored_irq_masks[CAM_IFE_CSID_MAX_STORED_MSKS][CAM_IFE_CSID_IRQ_REG_MAX];
...
struct cam_ife_csid_ver3_top_reg_info {
...
struct cam_ife_csid_ver3_path_reg_info {
    ...
    uint32_t csi2_rx_irq_mask;
    bool     domain_id_supported;
    uint32_t domain_id_shift_val;
    uint32_t domain_id_cfg_num;
    uint32_t capabilities;
};

struct cam_ife_csid_ver3_common_reg_info {
    ...
    uint32_t group_pri_sec_cfg_addr;
    ...
    uint32_t domain_id_cfg0_addr;
    uint32_t domain_id_cfg1_addr;
...
struct cam_ife_csid_ver3_reg_info {
    struct cam_irq_controller_reg_info               *irq_reg_info;
    struct cam_irq_controller_reg_info               *buf_done_irq_reg_info;
    const struct cam_ife_csid_ver3_common_reg_info   *cmn_reg;
    ...
    const int                                         input_core_sel[
            CAM_IFE_CSID_HW_NUM_MAX][CAM_IFE_CSID_INPUT_CORE_SELECT_MAX];
...
/*
 * struct cam_ife_csid_token_information: place holder for csid res path context private data
 *
 ...
 *
 */
struct cam_ife_csid_token_information {
	void                    *token;
	int                      res_id;
};

/*
 * struct cam_ife_csid_ver3_hw: place holder for csid hw
 *
...
struct cam_ife_csid_ver3_hw {
    ...
    struct cam_ife_csid_ver3_evt_payload   rx_evt_payload[
                        CAM_IFE_CSID_VER3_PAYLOAD_MAX];
    struct cam_ife_csid_ver3_evt_payload   path_evt_payload[
                        CAM_IFE_CSID_VER3_PAYLOAD_MAX];
    ...
    struct cam_ife_csid_token_information  token_data[CAM_IFE_PIX_PATH_RES_MAX];
 ...
 */
struct cam_ife_csid_ver3_res_mini_dump {
    uint32_t                           res_id;
 ...
 * @hw_state:        hw state
 */
struct cam_ife_csid_ver3_mini_dump_data {
    struct cam_ife_csid_ver3_res_mini_dump  res[CAM_IFE_PIX_PATH_RES_MAX];
    struct cam_ife_csid_hw_flags            flags;
    struct cam_ife_csid_rx_cfg              rx_cfg;
    struct cam_ife_csid_cid_data            cid_data[CAM_IFE_CSID_CID_MAX];
    uint64_t                                clk_rate;
...
int cam_ife_csid_hw_ver3_init(struct cam_hw_intf  *csid_hw_intf,
    struct cam_ife_csid_core_info *csid_core_info,
    bool is_custom);

int cam_ife_csid_hw_ver3_deinit(struct cam_hw_info *hw_priv);
void cam_ife_csid_ver3_print_illegal_programming_irq_status(void *csid_hw, void *res);
void cam_ife_csid_ver3_print_format_measure_info(void *csid_hw, void *res);
void cam_ife_csid_hw_ver3_mup_mismatch_handler(void *csid_hw, void *res);
void cam_ife_csid_hw_ver3_rdi_line_buffer_conflict_handler(void *csid_hw);
