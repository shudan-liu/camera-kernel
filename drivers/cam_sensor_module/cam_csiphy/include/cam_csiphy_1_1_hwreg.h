...
struct cam_cphy_dphy_status_reg_params_t status_regs_1_1_0 = {
...
struct csiphy_reg_parms_t csiphy_v1_1 = {
	...
	.status_reg_params = &status_regs_1_1_0,
	.size_offset_betn_lanes = 0x200,
	.csiphy_interrupt_status_size = 11,
	.csiphy_num_common_status_regs = 11,
	.csiphy_common_array_size = 7,
	.csiphy_common_3ph_array_size = 6,
	.csiphy_extra_3ph_2p5G_array_num = 3,
	.csiphy_extra_3ph_2p5G_array_size = 4,
	.csiphy_reset_enter_array_size = 4,
	.csiphy_reset_exit_array_size = 1,
	.csiphy_2ph_config_array_size = 15,
	.csiphy_3ph_config_array_size = 43,
	.csiphy_3ph_2p5G_array_num = 3,
	.csiphy_3ph_2p5G_array_size = 22,
	.csiphy_3ph_1p5G_array_num = 3,
	.csiphy_3ph_1p5G_array_size = 22,
	.csiphy_3ph_2p5G_extra_halfrate_array_num = 3,
	.csiphy_3ph_2p5G_extra_halfrate_array_size = 5,
	.csiphy_3ph_1p5G_extra_halfrate_array_num = 3,
	.csiphy_3ph_1p5G_extra_halfrate_array_size = 4,
...
struct csiphy_reg_t csiphy_common_reg_1_1[] = {
	...
	{0x081C, 0x58, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0814, 0xd5, 0x00, CSIPHY_LANE_ENABLE},
	{0x0818, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x081C, 0x5A, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0824, 0x72, 0x00, CSIPHY_DEFAULT_PARAMS},
};

struct csiphy_reg_t csiphy_common_3ph_reg_1_1[] = {
	{0x0884, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x088C, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x081C, 0x58, 0x00, CSIPHY_DEFAULT_PARAMS},
...
struct csiphy_reg_t csiphy_extra_3ph_2p5G_reg_1_1[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
...
struct csiphy_reg_t csiphy_reset_enter_reg_1_1_0[] = {
...
struct csiphy_reg_t csiphy_reset_exit_reg_1_1_0[] = {
	{0x0800, 0x02, 0x00, CSIPHY_2PH_REGS},
};

struct csiphy_reg_t csiphy_reset_exit_3ph_reg_1_1_0[] = {
...
csiphy_reg_t csiphy_2ph_v1_1_reg[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
		...
		{0x0008, 0x0E, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0028, 0x00, 0x00, CSIPHY_DNP_PARAMS},
		{0x000C, 0x00, 0x00, CSIPHY_DNP_PARAMS},
	},
	{
		{0x0730, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0724, 0x03, 0x00, CSIPHY_DEFAULT_PARAMS},
		...
		{0x0708, 0x0E, 0x00, CSIPHY_DEFAULT_PARAMS},
	},
	{
		...
		{0x0208, 0x0E, 0x00, CSIPHY_DEFAULT_PARAMS},
	...
	},
	{
		...
		{0x0408, 0x0E, 0x00, CSIPHY_DEFAULT_PARAMS},
	...
	},
	{
		...
		{0x0608, 0x0E, 0x00, CSIPHY_DEFAULT_PARAMS},
...
struct
csiphy_reg_t csiphy_3ph_2p5G_v1_1_reg[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
		...
		{0x010C, 0x1C, 0x00, CSIPHY_SETTLE_CNT_LOWER_BYTE},
		{0x0108, 0x1C, 0x00, CSIPHY_SETTLE_CNT_HIGHER_BYTE},
		{0x0114, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
	...
	},
	{
		...
		{0x030C, 0x1C, 0x00, CSIPHY_SETTLE_CNT_LOWER_BYTE},
		{0x0308, 0x1C, 0x00, CSIPHY_SETTLE_CNT_HIGHER_BYTE},
		{0x0314, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
	...
	},
	{
		...
		{0x050C, 0x1C, 0x00, CSIPHY_SETTLE_CNT_LOWER_BYTE},
		{0x0508, 0x1C, 0x00, CSIPHY_SETTLE_CNT_HIGHER_BYTE},
		{0x0514, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
...
struct
csiphy_reg_t csiphy_3ph_1p5G_v1_1_reg[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
		{0x015C, 0x46, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0168, 0x80, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x016C, 0x25, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0104, 0x06, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x010C, 0x26, 0x00, CSIPHY_SETTLE_CNT_LOWER_BYTE},
		{0x0108, 0x26, 0x00, CSIPHY_SETTLE_CNT_HIGHER_BYTE},
		{0x0114, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0150, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0188, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x018C, 0x7F, 0x00, CSIPHY_DEFAULT_PARAMS},
	...
	},
	{
		...
		{0x036C, 0x25, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0304, 0x06, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x030C, 0x26, 0x00, CSIPHY_SETTLE_CNT_LOWER_BYTE},
		{0x0308, 0x26, 0x00, CSIPHY_SETTLE_CNT_HIGHER_BYTE},
		{0x0314, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0350, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0388, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x038C, 0x7F, 0x00, CSIPHY_DEFAULT_PARAMS},
	...
	},
	{
		...
		{0x056C, 0x25, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0504, 0x06, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x050C, 0x26, 0x00, CSIPHY_SETTLE_CNT_LOWER_BYTE},
		{0x0508, 0x26, 0x00, CSIPHY_SETTLE_CNT_HIGHER_BYTE},
		{0x0514, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0550, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0588, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x058C, 0x7F, 0x00, CSIPHY_DEFAULT_PARAMS},
...
struct
csiphy_reg_t csiphy_3ph_2p5G_extra_halfrate_v1_1_reg[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
		...
		{0x09B4, 0x08, 0x00, CSIPHY_DEFAULT_PARAMS},
	},
	{
		...
		{0x0AB4, 0x08, 0x00, CSIPHY_DEFAULT_PARAMS},
	},
	{
		...
		{0x0BB4, 0x08, 0x00, CSIPHY_DEFAULT_PARAMS},
	},
};

struct
csiphy_reg_t csiphy_3ph_1p5G_extra_halfrate_v1_1_reg[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
		{0x0984, 0x20, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x09B0, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x09B4, 0x08, 0x00, CSIPHY_DEFAULT_PARAMS},
